            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item">
                        <a href="{{ route('dd-drug-history.index') }}">@lang('All Options')</a></li>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form id="departmentForm" class="form-material form-horizontal" action="{{ route('dd-drug-history.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
