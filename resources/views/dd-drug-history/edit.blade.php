            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form id="departmentForm" class="form-material form-horizontal"
                        action="{{ route('dd-drug-history.update', $DdDrugHistory) }}" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" id="name" name="title"
                                            value="{{ old('name', $DdDrugHistory->title) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" id="email" name="description"
                                            value="{{ old('email', $DdDrugHistory->description) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select
                                            ...
                                            <option value="1"
                                                {{ old('status', $DdDrugHistory->status) === '1' ? 'selected' : '' }}>
                                                @lang('Active')</option>
                                            <option value="0"
                                                {{ old('status', $DdDrugHistory->status) === '0' ? 'selected' : '' }}>
