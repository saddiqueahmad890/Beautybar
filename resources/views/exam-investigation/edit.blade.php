...
<section class="content-header">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item">
                        <a href="{{ route('exam-investigations.index') }}">{{ __('Existing Teeth Examinations') }}</a></li>
    ...
    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <select name="patient_id"
                                        ...
                                        required id="patient_id" {{ isset($examInvestigation) ? 'disabled' : '' }}>
                                        ...
                                        @foreach ($patients as $patient)
                                            <option value="{{ $patient->id }}"
                                                ...
                                                {{ $patient->name }} - {{ $patient->patientDetails->mrn_number ?? ' ' }}</option>
                                        @endforeach
                                    </select>
                                    @if (isset($examInvestigation))
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 col-xl-4">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    @if (isset($examInvestigation))
                                        <input type="text" class="form-control" value="{{ $examInvestigation->PatientAppointment->appointment_number }}"
                                            readonly>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 col-xl-4">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    @if (isset($examInvestigation))
                                        <input type="text" class="form-control" value="{{ $examInvestigation->doctor->name }}"
                                            readonly>
        ...
        <div class="col-md-6">
                ...
                <div class="type-of-selection" style="display: {{ isset($examInvestigation) ? 'block' : 'none' }};">
                ...
                <div class="area-bulk-selection" style="display: none; margin-top: 30px;">
                    <form id="teethForm" style="display: {{ isset($examInvestigation) ? 'block' : 'none' }};">
                        @csrf
                        @if (isset($examInvestigation))
                            <input type="hidden" name="doctor_id" value="{{ $examInvestigation->doctor_id }}">
                            <input type="hidden" name="patient_id" value="{{ $examInvestigation->patient_id }}">
                            <input type="hidden" name="examination_id" value="{{ $examInvestigation->id }}">
                        @endif
                        <div class="row">
                            <div class="col-md-12">
                ...
                <div class="modal-body">
                    <form id="toothIssueForm">
                        @if (isset($examInvestigation))
                            ...
                            <input type="hidden" name="patient_id" value="{{ $examInvestigation->patient_id }}">
                        @endif
                        <input type="hidden" id="examination_id" name="examination_id" value="{{ old('examination_id', isset($examInvestigation) ? $examInvestigation->id : '') }}">
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 col-xl-4">
                                <div class="form-group">
...
<script>
    ...
    function handleSingleSelection(teethElement) {
        ...
        $.ajax({
            url: '{{ url('/patient-teeth-issues') }}/' + examinationId + '/' + patientId + '/' + teeth_number,
            type: 'GET',
                success: function(response) {
    ...
    $('#teethFileTableBody').html('');
        if (response.files) {
            response.files.forEach(file => {
                var filePath = baseUrl + '/storage/uploads/patient/' + $('#record_id').val() + '/exam_investigations/' + $('#examination_id').val() + '/' + $('#tooth_number').val() + '/' + file.file_name;
                ...
                $('#teethFileTableBody').append(
                    `<tr id="file-row-${escapeFileName(file.file_name)}">
                        ...
                        <td>
                            ...
                            <span onclick="confirmDeleteTeethFile('${file.file_name}', 'teeth_files', '${$('#record_id').val()}', 'teethFileTableBody')" class="btn btn-danger">
    ...
    $('#openSliderButton').on('click', function() {
        var examinationId = $('#exampleModal #examination_id').val();
        var teethNumber = $('#tooth_number').val();
        fetchImages(examinationId, teethNumber);
    });

    function fetchImages(examinationId, teethNumber) {
        $.ajax({
            url: '{{ route('get-teeth-files') }}',
            type: 'GET',
            data: {
    ...
    function populateImageSlider(files) {
        ...
        var basePath = baseUrl + 'storage/uploads/patient/' + $('#record_id').val() + '/exam_investigations/' + $('#examination_id').val() + '/' + $('#tooth_number').val() + '/';
        console.log("This is file Path Slider",basePath);
    ...
    $.ajax({
        ...
        success: function(response) {
            if (response.success) {
                ...
                $(`#${tableBodyId}`).find(`#file-row-${fileType}-${escapedFileName}`).remove();
