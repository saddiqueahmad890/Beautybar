    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-material form-horizontal bg-custom" action="{{ route('users.update', $user) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input
                                            ...
                                            type="text" placeholder="@lang('Type Your Name Here')" required>
                                        @error('name')
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input
                                            ...
                                            type="email" placeholder="{{ __('Type Your Email Here') }}" required>
                                        @error('email')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select
                                            ...
                                            <option value="0"
                                                {{ old('role_for', $roleFor->role_for) == 0 ? 'selected' : '' }}>
                                                {{ __('System User') }}</option>
                                            <option value="1"
                                                {{ old('role_for', $roleFor->role_for) == 1 ? 'selected' : '' }}>
                                                {{ __('General User') }}</option>
                                        </select>
                                        @error('role_for')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input
                                            ...
                                            type="text" placeholder="{{ __('Type Phone Number Here') }}">
                                        @error('phone')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                        ...
                        <div id="staff_block">
                            <div class="form-group row col-12 p-0 m-0">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="col-md-12">
                                        <select class="form-control ambitious-form-loading" name="user_roles"
                                            id="user_roles">
                                            @foreach ($userRoles as $key => $role)
                                                <option value="{{ $key }}"
                                                    {{ old('user_roles', $roleFor->name) == $key ? 'selected' : '' }}>
                                                    {{ $role }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                {{-- <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <select class="form-control select2bs4" id="staff_company"
                                                name="staff_company" data-placeholder="Select a company">
                                                @foreach ($companies as $value)
                                                    <option value="{{ $value->id }}"
                                                        {{ old('staff_company', $value->id) == $cIdStd ? 'selected' : '' }}>
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <select
                                                ...
                                                @foreach ($staffRoles as $key => $role)
                                                    ...
                                                    ?>
                                                    <option value="{{ $key }}"
                                                        {{ (old('staff_roles') ?? $roleFor->name) == $key ? 'selected' : '' }}>
                                                        {{ $role_show }}
                                                    </option>
                                                @endforeach
                                            </select>
