            ...
            <div class="card">
                <div class="card-header bg-info">
                    ...
                    <div class="card-tools">
                        <a class="btn btn-primary" target="_blank" href="{{ route('users.index') }}?export=1"><i
                        ...
                        <tbody>
                            @foreach ($users as $user)
                                <tr>
                                    ...
                                    <td>{{ date($companySettings->date_format ?? 'Y-m-d', strtotime($user->created_at)) }}
                                    </td>
                                    <td>
                                        @if ($user->status)
                                    ...
                                    <td class="responsive-width">
                                        ...
                                        @endcan
                                        @can('user-delete')
                                            <a href="#" data-href="{{ route('users.destroy', $user->id) }}"
                                                class="responsive-width-item btn btn-info btn-outline btn-circle btn-lg"
