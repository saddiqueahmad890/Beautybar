    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h3>
                        <a href="{{ route('payments.index') }}" class="btn btn-outline btn-info"><i class="fas fa-eye"></i>
                            @lang('View All')</a>
                    </h3>
                </div>
                <div class="col-sm-6">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-info">
                    <h3 class="card-title">@lang('Edit Expense')</h3>
                </div>
                <div class="card-body">
                    <form id="accountForm" class="form-material form-horizontal bg-custom"
                        action="{{ route('payments.update', $payment->id) }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="row col-12 m-0 p-0">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group input-group mb-3">
                                        ...
                                        <input type="text" id="payment_date" name="payment_date"
                                            ...
                                            placeholder="@lang('Payment Date')" required data-parsley-required="true"
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="receiver_name">@lang('Title') <b class="ambitious-crimson">*</b></label>
                                    <div class="form-group input-group mb-3">
                                        <div class="input-group-prepend">
                                        ...
                                        <input type="text" id="receiver_name" name="receiver_name"
                                            ...
                                            data-parsley-required-message="@lang('Please enter Title.')"
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="account_name">@lang('Payment Mode') <b class="ambitious-crimson">*</b></label>
                                    <div class="form-group input-group mb-3">
                                        <div class="input-group-prepend">
                                        ...
                                        <input type="text"
                                            ...
                                            name="account_name" id="account_name" value="{{ old('account_name', $payment->account_name) }}"
                                            data-parsley-required="true" data-parsley-required-message="@lang('Please enter Payment Mode')"
                                            placeholder="@lang('Enter Payment Mode')">
                                        @error('account_name')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group input-group mb-3">
                                        ...
                                        <input type="number" id="amount" name="amount"
                                            ...
                                            placeholder="@lang('Amount')" required data-parsley-required="true"
                                            data-parsley-required-message="@lang('Please enter amount')" data-parsley-type="number"
                                            data-parsley-trigger="change">
                                        @error('amount')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                        ...
                        <div class="row col-12 m-0 p-0">
                            <div class="col-md-12 description_padding_left">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <textarea id="description" class="form-control" name="description">{{ old('description', $payment->description) }}</textarea>
                                        @error('description')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
