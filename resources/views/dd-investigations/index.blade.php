                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        @if(request()->has('isFilterActive'))
                                            <a href="{{ route('dd-investigations.index') }}" class="btn btn-secondary">@lang('Clear')</a>
                                        @endif
                                    </div>
                                </div>
                            </form>
                        ...
                        <tbody>
                            @foreach (  $ddInvestigations  as   $dd_investigation)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('dd-investigations.show', $dd_investigation ) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="tooltip" title="@lang('Edit')"><i class="fa fa-eye ambitious-padding-btn"></i></a>

                                        {{-- @endcan --}}
                                        {{-- @can('investigation-update') --}}
                                            <a href="{{ route('dd-investigations.edit',$dd_investigation ) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="tooltip" title="@lang('Edit')"><i class="fa fa-edit ambitious-padding-btn"></i></a>
                                        {{-- @endcan --}}
                                        {{-- @can('investigation-delete') --}}
                                            <a href="#" data-href="{{ route('dd-investigations.destroy', $dd_investigation) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="modal" data-target="#myModal" title="@lang('Delete')"><i class="fa fa-trash ambitious-padding-btn"></i></a>
                                        {{-- @endcan --}}
                                    </td>
                                </tr>
                            @endforeach
