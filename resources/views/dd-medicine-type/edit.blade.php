...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form id="blooggroupForm" class="form-material form-horizontal" action="{{ route('dd-medicine-types.update', $ddMedicineType) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="form-group input-group mb-3">
                                    ...
                                    <input type="text" id="name" name="name" value="{{ old('name', $ddMedicineType->name) }}" class="form-control @error('name') is-invalid @enderror" placeholder="@lang(' Name')" required>
                                    @error('name')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="form-group input-group mb-3">
                                    ...
                                    <input type="text" id="description" name="description" value="{{ old('description', $ddMedicineType->description) }}" class="form-control @error('description') is-invalid @enderror" placeholder="@lang(' description')" required>
                                    @error('description')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
