            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <table class="table table-striped" id="laravel_datatable">
                        <thead>
                            <tr>
                                <th style="text-wrap:nowrap;">@lang('PR Number')</th>
                                <th>Employee</th>
                                <th>Customer</th>
                                <th>@lang('Date')</th>
                        ...
                        <tbody>
                            @foreach ($prescriptions as $prescription)
                                <tr>
                                <td><span>{{ $prescription->examinvestigations->examination_number ?? ' '  }}</span></td>
                                    ...
                                    <td class="responsive-width">
                                        <a href="{{ route('prescriptions.show', $prescription) }}" class="responsive-width-item btn btn-info btn-outline btn-circle btn-lg" data-toggle="tooltip" title="@lang('View')"><i class="fa fa-eye ambitious-padding-btn"></i></a>
                                        @can('prescription-update')
                                            <a href="{{ route('prescriptions.edit', $prescription) }}?user_id={{ $prescription->user_id }}" class="responsive-width-item btn btn-info btn-outline btn-circle btn-lg" data-toggle="tooltip" title="@lang('Edit')"><i class="fa fa-edit ambitious-padding-btn"></i></a>
                                        @endcan
                                        @can('prescription-delete')
                                            <a href="#" data-href="{{ route('prescriptions.destroy', $prescription) }}" class="responsive-width-item btn btn-info btn-outline btn-circle btn-lg" data-toggle="modal" data-target="#myModal" title="@lang('Delete')"><i class="fa fa-trash ambitious-padding-btn"></i></a>
                                        @endcan
                                    </td>
                                </tr>
                            @endforeach
