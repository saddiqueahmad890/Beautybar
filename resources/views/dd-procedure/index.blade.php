            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">@lang('Services Category History')</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-info">
                    <h3 class="card-title">@lang('Services List')</h3>
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="procedure_category" class="form-control"
                                            value="{{ request()->procedure_category }}" placeholder="@lang('Services Category')">
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            value="{{ request()->title }}" placeholder="@lang('Services')">
                                        </div>
                                    </div>
                                    </div>
                                    ...
                                    <div class="col-sm-4 mt-sm-4">
                                        ...
                                        @if (request()->isFilterActive)
                                            <a href="{{ route('dd-procedures.index') }}"
                                                class="btn btn-secondary mt-sm-3">@lang('Clear')</a>
                                        @endif
                                    </div>
                                </div>
                            </form>
