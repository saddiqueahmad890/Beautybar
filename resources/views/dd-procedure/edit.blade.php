                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item">
                            <a href="{{ route('dd-procedures.index') }}">@lang('Services')</a>
                        </li>
                        <li class="breadcrumb-item active">@lang('Edit Services  ')</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-info">
                    <h3 class="card-title">Edit Services ({{ $ddProcedure->title }})</h3>
                </div>
                <div class="card-body">
                    <form id="departmentForm" class="form-material form-horizonta bg-custom"
                        action="{{ route('dd-procedures.update',$ddProcedure ) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row col-12 p-0 m-0">
                            ...
                            {{-- <div class="col-md-4">
                                <div class="form-group">
                                    <label for="extra">@lang('services_code')</label>
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                        ...
                                        <input type="text" id="procedure_code" name="procedure_code"
                                            ...
                                            class="form-control @error('services_code') is-invalid @enderror"
                                            placeholder="@lang('services_code')">
                                        @error('services_code')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                            ...
                            {{-- <div class="col-md-4">
                                <div class="form-group">
                                    <label for="info1">@lang('SN-No')</label>
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="info2">@lang('Price')</label>
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="info3">@lang('Services  ')</label>
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="fas fa-tag"></i></span>
                                        </div>
                                        <select id="dd_procedure_id" name="dd_procedure_id"
                                            class="form-control @error('dd_procedure_id') is-invalid @enderror">
