                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" id="title" name="title" value="{{ old('title',$examination->title) }}" class="form-control @error('title') is-invalid @enderror" placeholder="@lang('Title')" required>
                                        @error('title')
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" id="description" name="description" value="{{ old('description',$examination->description) }}" class="form-control @error('description') is-invalid @enderror" placeholder="@lang('Description')" required>
                                        @error('description')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select
                                            ...
                                            <option value="1"
                                            {{ old('status', $examination->status) == '1' ? 'selected' : '' }}>
                                            @lang('Active')
                                            </option>
                                            <option value="0"
                                                {{ old('status', $examination->status) == '0' ? 'selected' : '' }}>
                                                @lang('Inactive')
                                            </option>
                                        </select>
                                        @error('status')
