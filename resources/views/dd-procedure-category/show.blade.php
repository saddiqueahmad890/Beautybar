            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item">
                        <a href="{{ route('dd-procedure-categories.index') }}">@lang('Services Category History')</a>
                    </li>
                    <li class="breadcrumb-item active">@lang('Services Category Information')</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header bg-info">
                <h3 class="card-title">@lang('Services Category Information')</h3>
