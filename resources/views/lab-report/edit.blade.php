...
<input type="hidden" id="table_name" value="Lab Report">
<div class="row">
    <div class="col-12">
        <div class="card">
...
<div class="card">
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-12">
                <div class="col-md-12">
                    <input id="lab_files" name="lab_files[]" type="file" multiple
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody id="labFilesTableBody" class="fileTableBody"></tbody>
