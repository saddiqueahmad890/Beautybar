...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    @endif --}}
        ...
        <li class="nav-item dropdown">
            <a data-bs-toggle="tooltip" data-bs-placement="right" title="Notifiction" class="nav-link dropdown-toggle"
                ...
                <span style="top:4px; position:absolute; left: 16px;" class="badge badge-pill badge-danger"
                    id="notificationCount">{{ $notifications->where('status', 'new')->where('user_id', Auth::user()->id)->count() }}</span>
            </a>
            @if ($notifications)
        ...
        {{-- <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="taskNotificationDropdown">
                <h6 class="dropdown-header">Notifications</h6>
                <div id="taskNotificationList">
                </div>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item text-center" href="{{ route('tasks.index') }}">View All Tasks</a>
            </div>
        </li> --}}
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                <div class="dw-user-box">
                    ...
                    <div class="u-text">
                        ...
                        <p class="text-muted custom-padding-bottom-5">
...
<script>
    ...
    async function markAllNotificationsAsRead() {
        try {
            const response = await fetch('/dental/notifications/read-all', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute(
