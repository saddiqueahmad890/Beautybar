    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="treatmentForm" class="form-material form-horizontal"
                        action="{{ route('dd-treatment-plans.update', $ddTreatmentPlan) }}" method="POST">
                        @csrf
                        @method('PUT')
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select
                                            ...
                                            <option value="1"
                                                {{ old('status', $ddTreatmentPlan->status) == '1' ? 'selected' : '' }}>
                                                @lang('Active')
                                            </option>
                                            <option value="0"
                                                {{ old('status', $ddTreatmentPlan->status) == '0' ? 'selected' : '' }}>
                                                @lang('Inactive')
                                            </option>
                                        </select>
                                        @error('status')
