    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="treatmentForm" class="form-material form-horizontal" action="{{ route('dd-treatment-plans.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                ...
                                <a href="{{ route('dd-treatment-plans.index') }}" class="btn btn-outline btn-warning btn-lg">{{ __('Cancel') }}</a>
                            </div>
                        </div>
                    </form>
                </div>
