        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6 d-flex">
                    <h3 class="mr-2"><a href="{{ route('dd-medicine.create') }}" class="btn btn-outline btn-info">+ @lang('Add New Medicine')</a></h3>
                     <h3>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="medicineForm" class="form-material form-horizontal"
