            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">@lang('Dental History')</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-info">
                    <h3 class="card-title">@lang('Dental History List')</h3>
                    <div class="card-tools">
                         <a class="btn btn-primary float-right" target="_blank" href="{{ route('dd-dental-history.index') }}?export=1">
                ...
                <div class="card-body">
                    ...
                    <table class="table table-striped" id="laravel_datatable">
                        ...
                        <tbody>
                            @foreach ($dentalHistories as $DdDentalHistory)
                                <tr>
                                    <td>{{ $DdDentalHistory->title }}</td>
                                    <td>{{ $DdDentalHistory->description }}</td>
                                    ...
                                    <td>
                                        <a href="{{ route('dd-dental-history.show', $DdDentalHistory) }}"
                                        ...
                                        @can('doctor-detail-update')
                                            <a href="{{ route('dd-dental-history.edit', $DdDentalHistory) }}"
                                                class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="tooltip"
                                                title="@lang('Edit')"><i class="fa fa-edit ambitious-padding-btn"></i></a>
                                        @endcan

                                        <a href="#"
                                            data-href="{{ route('dd-dental-history.destroy', $DdDentalHistory) }}"
                    ...
                    {{ $dentalHistories->withQueryString()->links() }}
