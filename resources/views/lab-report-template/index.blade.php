                        ...
                        <tr>
                            ...
                            <td class="responsive-width">
                                ...
                                @can('lab-report-template-delete')
                                    <a href="#" data-href="{{ route('lab-report-templates.destroy', $labReportTemplate) }}" class="responsive-width-item btn btn-info btn-outline btn-circle btn-lg" data-toggle="modal" data-target="#myModal" title="@lang('Delete')"><i class="fa fa-trash ambitious-padding-btn"></i></a>
                                @endcan
                            </td>
                        </tr>
                        @endforeach
