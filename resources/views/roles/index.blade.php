                ...
                <div class="card-body">
                    ...
                    <table class="table table-striped" id="laravel_datatable">
                        ...
                        <tbody>
                            ...
                            <?php $role_show = $role->name;
                            if($role_show == 'Patient'){$role_show = 'Customer'; }if($role_show == 'Doctor'){ $role_show = 'Employee';} ?>
                                <tr>
                                    ...
                                    <td class="responsive-width">
                                        @can('role-update')
                                            <a href="{{ route('roles.edit', $role) }}" class="responsive-width-item btn btn-info btn-outline btn-circle btn-lg" data-toggle="tooltip" title="@lang('Edit')"><i class="fa fa-edit ambitious-padding-btn"></i></a>
                                        @endcan
                                        @can('role-delete')
                                            <a href="#" data-href="{{ route('roles.destroy', $role) }}" class="responsive-width-item btn btn-info btn-outline btn-circle btn-lg" data-toggle="modal" data-target="#myModal" title="@lang('Delete')"><i class="fa fa-trash ambitious-padding-btn"></i></a>
                                        @endcan
                                    </td>
                                </tr>
                            @endforeach
