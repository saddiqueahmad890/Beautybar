                                ...
                                <div class="form-control-plaintext">
                                    @php
                                        ...
                                        $dont_show_permissions = [
                                            ...
                                            'Marital Status',
                                            'Consultancy',
                                            'Delete Patient Dental Histories',
                                            'Insurance Provider',
                                            'Task',
                                            'Lab Report Template',
                                            'Lab Report',
                                    ...
                                    @foreach ($permissions as $permission)
                                        @if (!in_array($permission->display_name, $dont_show_permissions))
                                            ...
                                            @if ($display == 'read')
                                                <div class="role-form-ambi checkbox checkbox-info">
                                                    <input name="permission[]" id="permission_{{ $permission->id }}"
                                                        type="checkbox" value="{{ $permission->id }}"
                                                        @if (is_array(old('permission', $rolePermissions)) && in_array($permission->id, old('permission', $rolePermissions))) checked @endif>
