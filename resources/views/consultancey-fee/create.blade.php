            ...
            <div class="col-md-6">
                <div class="form-group row">
                    ...
                    <div class="col-md-12 d-flex align-items-center">
                        <a href="{{ route('patient-details.index') }}" class="tn btn-outline btn-warning btn-lg">
                            @lang('Patient List')
                        </a>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('consultancey-fees.store') }}" method="POST">
                        @csrf
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="date">@lang('Consultancy Fee Date') <b class="text-danger">*</b></label>
                                <input type="text" name="date" id="date"
                                    class="form-control @error('date') is-invalid @enderror" placeholder="@lang('Consultancy Fee Date')"
