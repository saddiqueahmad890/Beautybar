            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">@lang('Add Customer Appointment')</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-info">
                    <h3 class="card-title">@lang('Add Customer Appointment')</h3>
                </div>
                <div class="card-body">
                    <form id="scheduleForm" class="form-material form-horizontal"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="doctor_id">@lang('Select Employee') <b class="ambitious-crimson">*</b></label>
                                    <div class="form-group input-group mb-3">
                                        <div class="input-group-prepend">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="date" name="appointment_date" id="appointment_date"
                                            ...
                                            placeholder="@lang('Appointment Date')" value="{{ old('appointment_date') }}">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="appointment_slot">@lang('Available Appointment Slots') <b
                                            class="ambitious-crimson">*</b></label>
                                    <div class="form-group input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="fas fa-user-clock"></i></span>
                                        </div>
                                        <select class="form-control @error('appointment_slot') is-invalid @enderror"
                                            name="appointment_slot" id="appointment_slot" required>
                                        </select>
