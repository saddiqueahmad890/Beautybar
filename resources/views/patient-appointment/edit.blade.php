            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item">
                        <a href="{{ route('patient-appointments.index') }}">@lang('Customer Appointment')</a></li>
                    <li class="breadcrumb-item active">@lang('Edit Customer Appointment')</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header bg-info">
                <h3 class="card-title">@lang('Edit Customer Appointment')</h3>
            </div>
            <div class="card-body">
