            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">@lang('Update Services Invoice')</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-info">
                    <h3 class="card-title">@lang('Update Services Invoice')</h3>
                </div>
                <div class="card-body">
                                    ...
                                    <table id="t1" class="table">
                                        <thead>
                                            <tr>
                                                ...
                                                {{-- <th scope="col" class="custom-th-width-5">@lang('Quantity')</th> --}}
                                                    ...
                                                    <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <select name="doctors[]" id="doctors"
                                                                    class="form-control doctors" required>
                                                                    <option value="" selected>Select Employee
                                                                    </option>
                                                                    @foreach ($doctors as $doctor)
                                                                        <option value="{{ $doctor->id }}"
                                                                            @if ($invoiceItem->doctor_id == $doctor->id) selected @endif>
                                                                            {{ $doctor->name }}</option>
                                                                    @endforeach
                                                                </select>
                                                            </td>
                                                            ...
                                                            <td>
                                                                <select name="procedure[]" id="procedure"
                                                                    ...
                                                                    @foreach ($ddProcedures as $ddProcedure)
                                                                        <option value="{{ $ddProcedure->id }}"
                                                                            @if ($invoiceItem->procedure_id == $ddProcedure->id) selected @endif>
                                                        ...
                                                        <td>
                                                            ...
                                                            <td>
                                                                ...
                                                                <input type="number" step=".01"
                                                                    name="discount_pct[]"
                                                                    value="{{ $invoiceItem->discount_pct }}"
                                                                    class="form-control discount_pct" placeholder="%"
                                                                    min="0.00" max="100.00" readonly>
                                            ...
                                            <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <select name="procedure_categories[]"
                                                            ...
                                                            id="procedure_categories">
                                                            <option value="" selected>Select Services Category
                                                            </option>
                                                            @foreach ($procedureCategories as $procedureCategory)
                                                                <option value="{{ $procedureCategory->id }}">
                                                                    {{ $procedureCategory->title }}</option>
                                                ...
                                                <td>
                                                    ...
                                                    <input type="number" step=".01" name="discount_pct[]"
                                                        ...
                                                        class="form-control discount_pct" placeholder="%" min="0.00"
                                                        max="100.00">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <input type="number" step=".01" name="total_discount"
                                                        ...
                                                        class="form-control total_discount" placeholder="%">
                                                </td>
                                                <td></td>
                                            </tr>
                                            <tr>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="d-flex gap-2">
                                        ...
                                        <a href="{{ route('invoices.show', $invoice->id) }}?type={{ request()->query('type') }}" id="printButton"
                                            class="btn btn-primary btn-lg">{{ __('Print Invoice') }}</a>
