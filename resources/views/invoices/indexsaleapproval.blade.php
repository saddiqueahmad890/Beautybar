                    ...
                    <div id="filter" class="collapse @if (request()->isFilterActive) show @endif">
                        <div class="card-body border">
                            <form action="{{ route('invoice.index') }}" method="get" role="form" autocomplete="off">
                                ...
                                <input type="hidden" name="approve" value="{{ request()->query('approve') }}">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        @if (request()->isFilterActive)
                                            <a href="{{ route('invoice.index', ['type' => request()->query('type'), 'approve' => request()->query('approve')]) }}"
                        ...
                        <tbody>
                            ...
                            @foreach ($paginatedInvoices as $invoice)
                                <tr>
                                    ...
                                    <td>
                                        @if ($invoice['invoice_approved'] === 'no')
