...
class AccountHeaderController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $accountHeaders = $this->filter($request)->orderby('id','desc')->paginate(10);
    ...
    public function store(Request $request)
    {
        ...
        $acccount=AccountHeader::create($data);
        return redirect()->route('account-headers.edit',$acccount->id)->with('success', trans('Account Header Added Successfully'));
    }
