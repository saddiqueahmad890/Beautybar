...
class PatientTreatmentPlanProcedureController extends Controller
{
    ...
    {
        $data = $request->only(['patient_treatment_plan_id','tooth_number','dd_procedure_id','status','is_procedure_started','is_procedure_finished']);
        $attributes = [
        ...
        PatientTreatmentPlanProcedure::updateOrCreate($attributes, $data);
